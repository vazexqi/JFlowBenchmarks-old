...
public final class Bitstream {
	...
	/**
	 * Maximum size of the frame buffer. max. 1730 bytes per frame: 144 * 384kbit/s / 32000 Hz + 2
	 * Bytes CRC
	 */
	...
	/**
	 * Get next 32 bits from bitstream. They are stored in the headerstring. syncmod allows Synchro
	 * flag ID The returned value is False at the end of stream.
	 * 
	 * @param syncMode
	 */
	...
	/**
	 * Read bits from buffer into the lower bits of an unsigned int. The LSB contains the latest
	 * read bit of the stream. (1 <= numberOfBits <= 16)
	 */
	 ...
	 * 
	 * @exception Exception is thrown if the specified number of bytes could not be read from the
	 *                stream.
	 */
