...
/**
 * Class Implementing Layer 3 Decoder. http://www.oreilly.com/catalog/mp3/chapter/ch02.html Maximum
 * bitreservoir is 511 byte. http://www.hydrogenaudio.org/forums/lofiversion/index.php/t42194.html
 * gr: granules (sub-frames)
 */
final class Layer3Decoder {
	...
	/**
	 * Reads the side info from the stream, assuming the entire frame has been read already. Mono :
	 * 136 bits (= 17 bytes) Stereo : 256 bits (= 32 bytes)
	 */
