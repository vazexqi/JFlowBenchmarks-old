...
public class GlobalBean {
     ...
     */
    public static void leftAppendString(StringBuffer string, String s,
                                        String t) {
    ...
    public static int stripOffLabel(StringBuffer input_string) {
        int c;
    ...
    public static boolean specialCommand(StringBuffer input_string, Dictionary dict,ParseOptions opts) {
        ...
        if (input_string.charAt(0) == COMMENT_CHAR)
            return true;
        if (input_string.charAt(0) == '!') {
            opts.issueSpecialCommand(input_string.substring(1), dict);
            return true;
        }
        return false;
    }

    public static void batchProcessSomeLinkages(int label, Sentence sent, ParseOptions opts) throws IOException {
        Linkage linkage;
    ...
    public static void processSomeLinkages(Sentence sent, ParseOptions opts) throws IOException {
        ...
        for (i = 0, num_displayed = 0; i < num_to_query; ++i) {
            ...
            if (++num_displayed < num_to_query) {
                ...
                c = fgetInputChar(System.in, opts);
                if (c != '\n' && c != '\r') {
                    input_char = c;
                    input_pending = true;
                    break;
    ...
    public static boolean fgetInputString(StringBuffer input_string, InputStream in, PrintStream out, ParseOptions opts) throws IOException {
        int c;
