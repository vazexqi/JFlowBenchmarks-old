 ...
 * sentence,_create, sentence_parse, in that order. Then you can process links.
 * 
...
public class Linkage {
	 ...
	 * mySentence.sentence_num_linkages_found() on your instantiated sentence.
	 ...
	 * 
	 * @param sent
	 *            sentence to extract links from. TODO - does not set the
	 *            current Linkage objects this.sent to sent. This may be a bug!
	 * @param opts
	 *            options to use when processing TODO - does not set the current
	...
	/**
	 * 
	 * The old C comment said -- This procedure mimics analyze_fat_linkage in
	 ...
	 * 
	 * @param s
	 *            Empty stringbuffer supplied by the caller shich the method
	 *            will use
	 * @param link
	 ...
	 * 
	 * @param mode
	 *            mode 1: treebank-style constituent tree mode 2: flat,
	 ...
	 * 
	 * @param mode
	 *            Print out the constituent tree. mode 1: treebank-style
