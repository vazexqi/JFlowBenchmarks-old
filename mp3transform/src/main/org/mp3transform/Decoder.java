...
public class Decoder {
	...
	public static Decoder createBenchmarkDecoder() {
		Decoder decoder= new Decoder();
		decoder.BENCHMARK= true;
		decoder.initOutputBuffer(null, MAX_CHANNELS);
		return decoder;
	}

	public byte[] decodeFrame(Header header, Bitstream stream) throws IOException {
		if (!initialized) {
