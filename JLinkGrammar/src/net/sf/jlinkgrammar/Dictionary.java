 ...
 *      opts)
 * @see Sentence#sentenceParse(ParseOptions opts)
 */
public class Dictionary {
     ...
     *
     * @param opts       the set of parse options is copied into the Sentence object
     *                   and Linkage Object as well as the GlobalBean Object TODO -
     *                   design the ParseOptions record keeping for better object
     *                   encapsulation
     * @param dict_name  If this is a FQPN then it is used to set the path to all
     *                   resources
     ...
     * @param path       the colon separated path variable (from env?) used to find the
     *                   dictionaries
     */
     ...
     * @param dictname the dictionary to use. If fully qualified then sets the path
     *                 for affix, etc.
     * @param path     Colon separated list of directories to search for ditionary,
     *                 postprocessor etc.
     * @see Postprocessor
     * @see Dictionary#Dictionary(ParseOptions, String, String, String, String,
     *      String)
    ...
    void dict_display_word_info(String s) {
        ...
        for (; dn != null; dn = dn.right) {
            ...
            opts.out.print("          ");
            opts.leftPrintString(dn.string, "                  ");
            opts.out.print(" " + len + "  ");
            if (dn.file != null) {
     ...
     *
     * @param p points to a list of dict_nodes connected by their left
     *          pointers
